...
map.getView().fit([-8086636.164953, -5247020.380042, -8010552.626697, -5192531.594585], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Huinay Terreste - Senderos y Limites</h2>';
        return titleElement;
    })(),
